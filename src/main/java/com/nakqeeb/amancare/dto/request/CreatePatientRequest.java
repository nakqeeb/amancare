// =============================================================================
// Patient Request DTOs - كائنات طلب المرضى
// =============================================================================
 ...
 * طلب إنشاء مريض جديد
 */
@Schema(description = "طلب إنشاء مريض جديد")
public class CreatePatientRequest {

    @Schema(description = "الاسم الأول", example = "محمد", required = true)
    ...
    @Schema(description = "الاسم الأخير", example = "أحمد", required = true)
    ...
    @Schema(description = "الجنس", example = "MALE", required = true)
    @NotNull(message = "الجنس مطلوب")
    private Gender gender;

    @Schema(description = "رقم الهاتف", example = "771234567", required = true)
